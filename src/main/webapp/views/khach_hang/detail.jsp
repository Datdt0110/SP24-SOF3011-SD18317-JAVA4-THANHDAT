...
<div class="container">
    <form action="/khach-hang/update" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="ten"value="${s.ten}">
        </div>
        <div class="mb-3">
            <label class="form-label">Địa Chỉ</label>
            <input type="text" class="form-control" name=diaChi value="${s.diaChi}">
        </div>
        <div class="mb-3">
            <label class="form-label">Số Điện Thoại</label>
            <input type="text" class="form-control" name=sdt value="${s.sdt}">
        </div>
        <div class="mb-3">
